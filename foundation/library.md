...
The Library surface: the topic pages (HRT, Mood, Sleep, Diet, Family, All Topics)
plus Topic Center and Article Show. These are reached **through** the slide-out
panel's Library section — the panel *container* itself is nav chrome, specified in
...
The Library section appears in **every** persona's panel. Section label "LIBRARY".
...
|---|---|---|
| Topic Center | `topic` | All Topics (`lib-all`) |
| Article Show | `article` | Topic Center (`topic`) |

The splash's "one Article card" opens a separate Article Show that levels up
through **Collection → All Collections** instead — that collection chain is a
Splash Landing deep-link, documented in [landing.md](landing.md).
